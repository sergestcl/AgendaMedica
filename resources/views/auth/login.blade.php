      ...
      <div class="col-lg-5 col-md-7">
        <div class="card bg-secondary shadow border-0">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            @if ($errors->any())
            <div class="text-center text-muted mb-">
            ...
            <div class="text-center text-muted mb-4">
                <small>Ingresa tus credenciales para inciar sesión</small>
            </div>
            @endif
            ...
            <form role="form" method="POST" action="{{ route('login') }}">
              ...
              <div class="custom-control custom-control-alternative custom-checkbox">
                <input nambe="remember" class="custom-control-input" id="remember" type="checkbox" {{ old('remember') ? 'checked' : '' }}>
                <label class="custom-control-label" for="remember">
                  <span class="text-muted">Permanecer conectado</span>
                </label>
              </div>
